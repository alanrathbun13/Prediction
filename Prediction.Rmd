...
#### Split training data frame into training set and validation set
```{r, echo=FALSE, message=FALSE, warning=FALSE}
set.seed(123)
...
```
<br>
* Accuracy of the final prediction model at classifying individuals within the training set 99.99%, which is almost perfect prediction
<br>
<br>
...
```
<br>
* The accuracy of the prediction function in the validation is 100% (perfect prediction). Out-of-sample classificaiton error is generally higher in validation samples, but in this case, the classification error is actually lower than within the training set. 
<br>
<br>

#### Predict outcomes using prediction and testing dataframe
```{r, echo=FALSE, message=FALSE, warning=FALSE}
